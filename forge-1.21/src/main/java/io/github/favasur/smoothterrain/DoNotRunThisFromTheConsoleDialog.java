...
public final class DoNotRunThisFromTheConsoleDialog {
	...
	public static void main(String... args) {
		final var modName = "SmoothTerrain";
		final var installLinkBtnLabel = "Help";
		final var modLoaderName = "Forge";
		final var installationUrl = "https://www.wikihow.com/Install-Minecraft-Forge";
		final var mainMsg = "You have tried to launch " + modName + " (a Minecraft mod) directly, but it is not an executable program or mod installer. You must install " + modLoaderName + " for Minecraft, and place this file in your mods directory instead.";
		final var guiMsg = mainMsg + "\nIf this is your first time installing mods for " + modLoaderName + ", click \"" + installLinkBtnLabel + "\" for a guide on how to do this.";
		final var cmdMsg = mainMsg + "\nIf this is your first time installing mods for " + modLoaderName + ", open \"" + installationUrl + "\" for a guide on how to do this.";
