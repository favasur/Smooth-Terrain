...
public class SmoothableHandlerTests {
	...
	private BlockStateBase createStubbedStateForAsm() {
		...
		var mockedState = Mockito.mock(BlockStateBase.class, Mockito.withSettings().extraInterfaces(ISmoothTerrainBlockState.class));
		var mock = (ISmoothTerrainBlockState) mockedState;
