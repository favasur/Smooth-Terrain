...
import static io.github.favasur.smoothterrain.client.render.MeshRenderer.*;

/**
 * NeoForge 1.21.x port of the Sodium/Embeddium renderer.
 * Handles rendering SmoothTerrain meshes through Sodium's chunk rendering pipeline.
 */
